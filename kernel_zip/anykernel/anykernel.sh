...
# Edit for A20 by @chatur27 on XDA
## AnyKernel setup
# begin properties
properties() { '
kernel.string=
...
ui_print "- Preparing device for new kernel";
...
ui_print "- Copying additional files..";
ui_print " ";
...
ui_print "- Installation of kernel and spectrum finished";
ui_print " ";

ui_print "- A20_changelog.txt has been copied to your";
ui_print "  internal storage..";
ui_print " ";

ui_print "- Reboot and enjoy. Thanks! :)";
